...
for(let i=0; i<agricultural_products.length ; i++){
    for(j=0;j<fertilizers.length;j++){
        if(agricultural_products[i].fertilizer_id === fertilizers[j].id){
            // console.log(fertilizers[j].name+"-"+agricultural_products[i].fertilizer_quantity+"-"+agricultural_products[i].id)
            let a=[]
            a+=agricultural_products[i].fertilizer_quantity
            console.log(a);
        }
    }
}